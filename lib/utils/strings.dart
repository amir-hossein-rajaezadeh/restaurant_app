class Strings {
  static String helloAmir = 'Hello Amir 👋🏻';
  static String itslaunchTime = 'It is launch time!';
  static String yourDeliveryAddress = 'Your delivery address';
  static String sampleAddress = 'Melvin Porter P.O. South Dakota';
